...
export const CHANGELOG: ReleaseNote[] = [
  {
    version: '0.16.0',
    date: '2026-09-21',
    headline: '手机点分析先看数，宽表一行一张卡',
    feature: {
      icon: 'pie-chart',
      title: '手机上的分析首页',
      desc: '在手机上点底栏的分析，落到一页常查的数：本月营业收入、收缴率、未来 12 月到期，值直接写在瓦上，不用进屏。点一枚瓦去那个屏，看到的是同一期。电脑上点分析仍然是经营驾驶舱。',
    },
    added: [
      { icon: 'table-2', title: '宽表的手机形态', desc: '月度台账这类列多的表，在手机上一行一张卡，点开看整行。', to: 'ledger' },

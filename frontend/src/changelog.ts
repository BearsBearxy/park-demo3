...
export const CHANGELOG: ReleaseNote[] = [
  {
    ...
    feature: {
      ...
      title: '页签和浏览器一样用',
      desc: '点左边导航，在当前页签打开（在首页上点的，开在新页签）；按住 Ctrl 点，开在新页签。页签能拖动换位置，点 + 新建，右键能固定、关闭其他。页面里点出去的链接，开在当前页签右边。',
    },
    added: [
      { icon: 'home', title: '首页', desc: '登录后先到这里：搜索、收藏的页面、最近打开的页面都在这一页。它固定在页签最左边，关不掉。', to: 'home' },
      { icon: 'star', title: '收藏', desc: '点页面名后面的 ☆ 收藏这一页，在首页上能找到，最多 12 个。' },
    ],
    improved: [
      { icon: 'arrow-left', title: '点路径回到这一层的第一屏', desc: '顶栏上「数据中心 / 园区抄表」这样的路径，点前面那段就回去。' },
      { icon: 'info', title: '顶栏图标有说明', desc: '鼠标在图标上停半秒，会说清它是做什么的。' },
      { icon: 'users', title: '在线的人看得清', desc: '头像放大了、上面写着名字的后两个字，旁边直接写几个人在线。' },
      { icon: 'pen-line', title: '正在改的页面不会被换掉', desc: '改到一半点左边导航，会开到新页签；关掉正在改的页签前会先问一句。' },
    ],
    fixed: [
      '月度台账、三大报表、账册模板、角色管理、新建合同改到一半关浏览器，原来不会先问一句',
    ],
  },
  {
    version: '0.13.0',

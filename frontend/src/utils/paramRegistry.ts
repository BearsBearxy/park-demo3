...
export const PARAM_DEFS: ParamDef[] = [
  ...
  { key: 'elec_resident', label: '居民裸电价（宿舍）', unit: '元/度', group: 'monthly', defaultMode: 'month', monthlyCheck: true, valueKind: 'money', monthOnly: true,
    formula: '电费 = 用量 × (裸电价 + 电力管理费)；缺当月电价整期不生成',
    hint: '单一价' },
  { key: 'elec_grid_avg', label: '供电局综合电价（月均裸价）', unit: '元/度', group: 'monthly', defaultMode: 'month', monthlyCheck: true, valueKind: 'money', monthOnly: true,
    formula: '二期损耗折算价 = 综合电价 + 电力管理费（缺当月值时按 平段裸价 + 管理费）',
    hint: '供电局账单 总金额 ÷ 总度数；源册火炬园「高压用电分配」单价同一个数（2024-02 二期 1.09312）' },

...
export const PARAM_DEFS: ParamDef[] = [
  ...
  { key: 'pv_crit_resid', label: '分栋 月偏离判据线', unit: '', group: 'constant', defaultMode: 'from', monthlyCheck: false, valueKind: 'rate',
    hint: '该栋该月比全园当日基准高或低超过这个比例，就在清单里记一行' },
  { key: 'pv_crit_disp_ratio', label: '分栋 月波动判据线', unit: '倍', group: 'constant', defaultMode: 'from', monthlyCheck: false, valueKind: 'number',
    formula: '园区同月中位波动 × 本倍数',
    hint: '不设固定百分比：波动的量纲跟园区自身规模走' },

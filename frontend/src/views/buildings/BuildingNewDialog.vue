...
.lg-dlg-mask { position:fixed; inset:0; background:var(--scrim); z-index:var(--z-modal); display:grid; place-items:center; opacity:0; animation:fp-fade-in var(--dur-base) forwards; }

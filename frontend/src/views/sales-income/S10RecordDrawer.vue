...
.s10d-finput { height:38px; width:100%; box-sizing:border-box; border:1px solid var(--border-control); border-radius:8px; padding:0 12px; font-family:var(--font-sans); font-size:13.5px; color:var(--text-primary); background:var(--surface-white); outline:none; transition:border-color var(--dur-fast); }
.s10d-finput:focus { border-color:var(--border-control-strong); }
.s10d-seg { display:flex; gap:6px; flex-wrap:wrap; }
.s10d-chip { flex:1 1 0; min-width:72px; height:38px; border:1px solid var(--border-control); background:var(--surface-white); border-radius:8px; cursor:pointer; font-family:var(--font-sans); font-size:13px; color:var(--text-secondary); display:flex; align-items:center; justify-content:center; gap:6px; transition:all var(--dur-fast); }
.s10d-chip:hover { background:var(--surface-card); }
.s10d-chip.on { border-color:var(--ink-900); background:var(--ink-900); color:var(--control-solid-text); }

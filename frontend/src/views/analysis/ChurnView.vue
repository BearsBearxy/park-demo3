    ...
    <div v-else class="ak-page">
      ...
      <div class="av2-grid">
        <div class="av2-card av2-s8">
          <div class="av2-card-h"><span class="t">风险象限散点</span><!-- 移动稿:交互话术(点点/悬停)只在桌面有意义,S 档由 hint-desk 收走;单位/图例解码留守 -->
          <span class="hint">环比 × 收款率 · 气泡=月应收 · 虚线=均值<span class="hint-desk"> · 点点→台账 · 超±范围的点钉在边缘(悬停看真值)</span></span></div>
          <AnaEChart :option="scatterOpt" :height="300" @chart-click="onScatterClick" />
        ...
        <div class="av2-card av2-s8">
          <div class="av2-card-h"><span class="t">流失预警明细</span><span class="hint">在租 {{ model.list.length }} 户 · 风险分降序前 {{ detail.length }}<span class="hint-desk"> · 点租户→台账</span></span></div>
        ...
        <div class="av2-card av2-s4">
          ...
          <AnaEChart :option="flowOpt" :height="300" />
        </div>
      </div>
    </div>
  </AnaShell>

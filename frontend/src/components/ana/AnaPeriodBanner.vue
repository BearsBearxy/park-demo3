...
<style scoped>
.ana-pbanner { display: flex; align-items: center; gap: 6px; background: #faeeda; color: var(--warn-text); border-radius: 8px; padding: 7px 12px; font-size: var(--fs-micro); line-height: 1.4; }
.ana-pbanner svg { flex: 0 0 auto; }
:root[data-theme="dark"] .ana-pbanner { background: var(--warn-bg); }
</style>

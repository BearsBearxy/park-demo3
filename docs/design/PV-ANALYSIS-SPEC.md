...
| # | 块 | 图种 | 栏 × 高 | 渲染 |
|---|---|---|---|---|
| B3 | 等效小时轨迹（**月档**） | ECharts 折线：13 条同色细灰 + 1 条全园加权粗线 | 8 × 250 | echarts |
| B4 | 等效小时 2024→2025（**年档，替 B3**） | 内联 SVG Tufte slopegraph，13 条线段，两端 direct label，无图例 | 8 × 250 | inline-svg |
| B5 | 各站年等效小时 vs 807.5 h | 内联 SVG bullet：零起点实测条 + 一根基准竖短线 + **单一中性底槽** | 4 × 250 | inline-svg |
...
- **B5 砍掉 Few 原规范的三档质性灰区间** —— 那三档本来就是 bad/ok/good，是严重度判词的连续版。
